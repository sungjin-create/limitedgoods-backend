...
//import com.limitedgoods.limitedgoods.event.outbox.publisher.kafka.KafkaOutboxPublisher;
...
//
//    private final KafkaOutboxPublisher publisher = new KafkaOutboxPublisher(
...
//        );
//
//        verify(outboxEventWriter).markPublished(event.getId());
//        verify(outboxEventWriter, never()).markFailed(anyLong(), any());
//    }
//
//    @Test
...
//
//        // then
//        verify(outboxEventWriter).markFailed(eq(event.getId()), any(Throwable.class));
//        verify(outboxEventWriter, never()).markPublished(anyLong());
//    }
//
//    @Test
